# -*- coding: utf-8 -*-
"""Extract Quotes from File

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16EkMkP3Zfm74HjxZRH5COYSmS_e2aCPI
"""

def extract_and_display_quotes(filename="quotes.txt"):
    """
    Reads quotes from a file, removes the author and quotation marks,
    and prints each quote on a new line.

    Args:
        filename (str, optional): The name of the file containing the quotes.
            Defaults to "quotes.txt". If the file does not exist, it creates
            it with default quotes.
    """
    try:
